package project.course.qmul.databox.instagram;
...
public class InstagramSession {
    ...
    private static final String API_MIN_ID = "min_id";
    ...
    public String getMinId() {
        return sharedPref.getString(API_MIN_ID, null);
    }

    public void storeMinId(String minId) {
        editor.putString(API_MIN_ID, minId);
        editor.commit();
    }
}